...
{
	{"10,43,31,44,56",14,{10,43,31,44},4},
	{"1,2,3",5,{},0},
	{"23,45,67",8,{},0},
	{"51,62,73,84",11,{51,62,73,84},4},
	{"-23,-56,-34,12",14,{},0},
	{"52,34",5,{52},1},
	{"",0,{},0},
	{"10",2,{10},1}
...
struct node* deleteRightMax(struct node *root)
{
	if(root!= NULL)
	{
...
void testcases()
{
	...
	for(i=0;i<8;i++)
	{
		...
		s[j]='\0';
		root = NULL;
		a = linkedList_To_Array(deleteRightMax(stringToLinkedList(s,root)),test[i].l);
		flag = 0;
