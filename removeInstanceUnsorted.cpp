...
{
	{"1,2,3,4,5",9,3,{1,2,4,5},4},
	{"1,2,2",5,2,{1},1},
	{"23,45,67,23,45,67",17,45,{23,67,23,67},4},
	{"1,2,3,3,2,1",11,1,{2,3,3,2},4},
	{"-23,-56,-34,12",14,5,{-23,-56,-34,12},4},
	{"12,34,34,12",11,34,{12,12},2},
	{"",0,5,{},0},
	{"1,1,1,1,1,1",11,1,{},0}
};
...
struct node* removeInstances(struct node *root,int k)
{
	if(root!= NULL && k!=0)
	{
		int i=1,flag=1;
...
void testcases()
{
	...
	for(i=0;i<8;i++)
	{
		...
		s[j]='\0';
		root = NULL;
		a = linkedList_To_Array(removeInstances(stringToLinkedList(s,root),test[i].k),test[i].l);
		flag = 0;
