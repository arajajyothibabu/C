...
{
	{"1,2,3,4,5",9,4,{1,2,3,5},4},
	{"1,2,3",5,4,{1,2,3},3},
	{"23,45,67",8,3,{23,45},2},
	{"1,2,3,4",7,1,{2,3,4},3},
	{"-23,-56,-34,12",14,3,{-23,-56,12},3},
	{"12,34",5,1,{34},1},
	{"",0,0,{},0},
	{"",0,3,{},0}
};
...
void testcases()
{
	...
	for(i=0;i<8;i++)
	{
		...
		s[j]='\0';
		root = NULL;
		a = linkedList_To_Array(deleteAtPosition(test[i].key,stringToLinkedList(s,root)),test[i].l);
		flag = 0;
