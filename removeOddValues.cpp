...
}test[8] =
{
	{"1,2,3,4,5",9,{2,4},2},
	{"1,2,2",5,{2,2},2},
	{"23,45,67,23,45,67",17,{},0},
	{"2,4,6,8,10",10,{2,4,6,8,10},5},
	{"-23,-56,-34,12",14,{-56,-34,12},3},
...
struct node* noOddValues(struct node *root)
{
	if(root!= NULL)
	{
		int i=1;
...
void testcases()
{
	...
	for(i=0;i<8;i++)
	{
		...
		s[j]='\0';
		root = NULL;
		a = linkedList_To_Array(noOddValues(stringToLinkedList(s,root)),test[i].l);
		flag = 0;
